...
$smarty = new Smarty;
	...
	//mysql_query("set names utf8");
        ...
        $behZustandArray = $apl->getBehaelterStandArray(0,FALSE,'BEH');
        $smarty->assign("behaelterZustandArray",  $behZustandArray);

        $behLagerplatzArray = $apl->getBehaelterLagerplatzArray();
        $smarty->assign("behaelterLagerplatzArray",  $behLagerplatzArray);
