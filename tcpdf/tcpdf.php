...
if(!class_exists('TCPDF', false)) {
	 ...
	 */ 
	define('PDF_PRODUCER','TCPDF 1.53.0.TC024 (http://tcpdf.sourceforge.net)');
	...
	*/
	class TCPDF {
		...
		*/
        ...
        protected $rechFootzeile1;
        protected $rechFootzeile2;
        protected $rechFootzeile3;


        /**
         * priznak zda se jedna o rechnung footer
         * @var <type> 
         */
        protected $rechnungFooter;
		...
		*/
         ...
         * @param <type> $z1
         * @param <type> $z2
         * @param <type> $z3 nastavi tri radky pro zapati
         * pouziva se v pripade zapati pro faktury
         */
        public function setRechnungZeilen($z1,$z2,$z3){
            $this->rechFootzeile1 = $z1;
            $this->rechFootzeile2 = $z2;
            $this->rechFootzeile3 = $z3;
        }

        /**
         *
         * nastavi priznak zda jde o zapati pro fakturu
         *
         * @param boolean $rf true = je to faktura , false neni to faktura
         *
         */
        public function setRechnungFoot($rf){
            $this->rechnungFooter = $rf;
        }
		/**
		...
		*/
		...
		public function Header() {
			if ($this->print_header) {
				...
				// header string
				$this->SetFont($this->header_font[0], $this->header_font[1], $this->header_font[2]-1);
				$this->SetX($header_x);
				$this->MultiCell($this->header_width, $cell_height, $this->header_string, 0, 'R', 0);
		...
		public function Footer() {
			if ($this->print_footer) {
				...
				//if ($this->barcode) {
                    ...
                    if($this->rechnungFooter){
                        //$this->SetY(2);
                        $this->Cell(0, 4, $this->rechFootzeile1, 'T', 1, 'L');
                        $this->Cell(0, 4, $this->rechFootzeile2, '0', 1, 'L');
                        $this->Cell(0, 4, $this->rechFootzeile3, '0', 1, 'L');
                    }
                    else{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// vlastni implementace multicell

		public function MyMultiCell($w, $h, $txt, $border=0, $align='J', $fill=0) {
			//Output text with automatic or explicit line breaks
			$cw = &$this->CurrentFont['cw'];
			$oldy=$this->y;
