...
"auss2"
=> array ("popis"=>"auss(2)","sirka"=>15,"ram"=>'B',"align"=>"R","radek"=>0,"fill"=>1),

"auss4"
=> array ("popis"=>"auss(4)","sirka"=>15,"ram"=>'B',"align"=>"R","radek"=>0,"fill"=>1),

"auss6"
=> array ("popis"=>"auss(6)","sirka"=>15,"ram"=>'B',"align"=>"R","radek"=>0,"fill"=>1),
...
function zapati_kunde($pdfobjekt,$childs,$vyskaradku,$popisek,$rgb,$summeArray)
{
    ...
    $obsah = number_format($summeArray['auss2'],0,',',' ');
	$pdfobjekt->Cell(15,$vyskaradku,$obsah,'BT',0,'R',$fill);

    $obsah = number_format($summeArray['auss4'],0,',',' ');
	$pdfobjekt->Cell(15,$vyskaradku,$obsah,'BT',0,'R',$fill);

    $obsah = number_format($summeArray['auss6'],0,',',' ');
	$pdfobjekt->Cell(15,$vyskaradku,$obsah,'BT',0,'R',$fill);
