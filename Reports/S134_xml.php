...
if($bTestOE) {
    $sql = "select dzeitsoll.persnr,dpers.name,dpers.vorname,dzeitsoll.oe,DATE_FORMAT(calendar.datum,'%Y-%m-%d') as datum,calendar.cislodne,";
...
if($bTestOE) {
    $sql_ist = "select dzeit.persnr,dpers.name,dpers.vorname,dzeit.tat as oe,DATE_FORMAT(calendar.datum,'%Y-%m-%d') as datum,calendar.cislodne,";
