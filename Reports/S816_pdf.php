...
function zapati_auftrag($pdfobjekt,$node,$vyskaradku,$popis,$rgb,$pole)
{
	...
	$pdfobjekt->Cell(20,$vyskaradku,$popis,'T',0,'L',$fill);
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "S816 T_nicht ausgeliefert", $params);
//set margins
...
foreach($auftraege as $auftrag)
{
	...
	$auftr_childs=$auftrag->childNodes;
	zahlavi_auftrag($pdf,5,array(255,255,200),$auftragsnr,$aufdat,$cells_header,$auftr_childs);
