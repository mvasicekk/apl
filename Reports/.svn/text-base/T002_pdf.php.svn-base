...
function zobrazDil(TCPDF $pdf,$childnodes,$levyOddil){
    ...
    $pdf->Write(5,"deska / Plate :");$pdf->Ln();
    $pdf->SetFont("FreeSans", "B", 9);
    $obsahBunky = getValueForNode($childnodes,"regal");
    $pdf->Write(5,$obsahBunky."levyoddil = $levyOddil");$pdf->Ln();
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "T002 Lagervisacky", $params);
//set margins
...
foreach($teile as $teil)
{
    ...
    zobrazDil($pdf,$teilChildNodes,$levastrana);
