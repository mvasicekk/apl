...
function pageheader($pdfobjekt,$cells,$childnodes)
{
	...
	$pdfobjekt->Cell(50,7,"D750",'TB',0,'L',0);
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "D750 Rechnung", $params);
//set margins
