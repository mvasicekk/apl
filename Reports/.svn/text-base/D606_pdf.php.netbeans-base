...
function zapati_import($pdfobjekt,$sum_array)
{
	...
	$pdfobjekt->Cell(125,6,"Summe Vzmin",'B',0,'L',0);
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "D606 Auftragsuebersicht (EX)", $params);
//set margins
...
$exporty=$domxml->getElementsByTagName("export");
