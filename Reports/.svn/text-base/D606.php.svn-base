...
$query = "
SELECT view_d606_dauftr.AuftragsNr, view_d606_dauftr.import_pal, view_d606_dauftr.export_pal, view_d606_dauftr.Teil, view_d606_dauftr.import_stk, view_d606_drueck.sum_stk_T, view_d606_drueck.sum_stk_P, view_d606_drueck.sum_stk_St, view_d606_drueck.sum_stk_G, view_d606_drueck.sum_stk_E, view_d606_drueck.auss2, view_d606_drueck.auss4, view_d606_drueck.auss6, view_d606_dauftr.S0011P, view_d606_dauftr.sumS0011P, view_d606_dauftr.cnt_S0011P, view_d606_dauftr.S0011T, view_d606_dauftr.sumS0011T, view_d606_dauftr.cnt_S0011T, view_d606_dauftr.S0041, view_d606_dauftr.sumS0041, view_d606_dauftr.cnt_S0041, view_d606_dauftr.S0051, view_d606_dauftr.sumS0051, view_d606_dauftr.cnt_S0051, view_d606_dauftr.S0061, view_d606_dauftr.sumS0061, view_d606_dauftr.cnt_S0061, view_d606_dauftr.imp_gew, view_d606_dauftr.sumvzkd, view_d606_dauftr.export_stk, view_d606_dauftr.aufdat, `sum_stk_Gtat`-`import_stk` AS GDiff
FROM (view_d606_dauftr LEFT JOIN view_d606_drueck ON (view_d606_dauftr.AuftragsNr = view_d606_drueck.AuftragsNr) AND (view_d606_dauftr.import_pal = view_d606_drueck.import_pal) AND (view_d606_dauftr.Teil = view_d606_drueck.Teil)) LEFT JOIN view_d606_drueck_gesamt ON (view_d606_dauftr.Teil = view_d606_drueck_gesamt.teil) AND (view_d606_dauftr.import_pal = view_d606_drueck_gesamt.import_pal) AND (view_d606_dauftr.AuftragsNr = view_d606_drueck_gesamt.AuftragsNr);
";
...
$sumF = 0;
$sumVzKd = 0;
While($D606=mysql_fetch_assoc($dbresult)){
$datum = split(" ", $D606['aufdat']);
  if($i==0){
  echo "<html>
  <head>
    <title>D606 Auftragsuebersicht (EX)</title>
    ...
    <table class='heading'>
      <tr>
        ...
        <td>
          <h1>D606 Auftragsuebersicht (EX)</h1>
        </td>
        <td>
          <h3>Import Datum:  ".$datum[0]."
            
            <span style='margin-left:5mm;'>
              Auftrag: (EX) ".$D606['AuftragsNr']."
  ...
  if($i==$pagCon){
    ...
    echo "<tr>
            <td>
              ".control($D606['AuftragsNr'])."</td>
            <td>
              ".$D606['Teil']."</td>
            <td>
              ".control($D606['import_pal'])."</td>
            <td>
              ".control($D606['export_pal'])."</td>
            <td style='border-right:2px solid black;'>
              ".control($D606['export_stk'])."</td>
            <td>                           
              ".control($D606['import_stk'])."</td>
            <td>                           
              ".control($D606['sum_stk_T'])."</td>
            <td>                           
              ".control($D606['sum_stk_P'])."</td>
            <td>                           
              ".control($D606['sum_stk_St'])."</td>
            <td>                           
              ".control($D606['sum_stk_G'])."</td>
            <td>
              ".control($D606['sum_stk_E'])."</td>
            <td>                           
              ".control($D606['auss2'])."</td>
            <td>                           
              ".control($D606['auss4'])."</td>
            <td>                           
              ".control($D606['auss6'])."</td>
            <td>".            
          control($D606['imp_gew'])."</td>
            <td>";
            $sumGDiff = $sumGDiff + control($D606['GDiff']);                           
              echo control($D606['GDiff'])."</td>
            <td class='slim'>                           
              ".control($D606['cnt_S0011T'])."</td>
            <td style='border-left:none;'>                           
              ".control($D606['S0011T'])."</td>
            <td>";
            $sumTr = $sumTr + control($D606['sumS0011T']);                           
              echo control($D606['sumS0011T'])."</td>
            <td class='slim'>                           
              ".control($D606['cnt_S0011P'])."</td>
            <td style='border-left:none;'>                           
              ".control($D606['S0011P'])."</td>
            <td>";     
            $sumP = $sumP + control($D606['sumS0011P']);                      
              echo control($D606['sumS0011P'])."</td>
            <td class='slim'>                           
              ".control($D606['cnt_S0041'])."</td>
            <td style='border-left:none;'>
              ".control($D606['S0041'])."</td>
            <td>";
            $sumSt = $sumSt + control($D606['sumS0041']);                           
              echo control($D606['sumS0041'])."</td>
            <td class='slim'>                           
              ".control($D606['cnt_S0051'])."</td>
            <td style='border-left:none;'>                           
              ".control($D606['S0051'])."</td>
            <td> ";
            $sumE = $sumE + control($D606['sumS0051']);                          
              echo control($D606['sumS0051'])."</td>
            <td class='slim'>                           
              ".control($D606['cnt_S0061'])."</td>
            <td style='border-left:none;'>                           
              ".control($D606['S0061'])."</td>
            <td>";
            $sumF = $sumF + control($D606['sumS0061']);                           
              echo control($D606['sumS0061'])."</td>
            <td>";
            $sumVzKd = $sumVzKd + control($D606['sumvzkd']);                           
              echo control($D606['sumvzkd'])."</td>
            </tr>";
...
$drop = "DROP VIEW `view_d606_dauftr`, `view_d606_drueck`, `view_d606_drueck_gesamt`";
