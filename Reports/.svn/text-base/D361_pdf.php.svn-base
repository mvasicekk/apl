...
"procent" 
=> array ("nf"=>array(2,',',' '),"popis"=>"","sirka"=>0,"ram"=>'1',"align"=>"R","radek"=>1,"fill"=>0),
...
"auftragsnr" 
=> array ("nf"=>array(0,',',' '),"popis"=>"auftragsnr","sirka"=>20,"ram"=>'B',"align"=>"L","radek"=>0,"fill"=>0),
...
"auss_celkem" 
=> array ("nf"=>array(0,',',' '),"popis"=>"Auss","sirka"=>10,"ram"=>'1',"align"=>"R","radek"=>0,"fill"=>0),

"gut_stk" 
=> array ("nf"=>array(0,',',' '),"popis"=>"GStk","sirka"=>15,"ram"=>'1',"align"=>"R","radek"=>0,"fill"=>0),

"procent" 
=> array ("nf"=>array(0,',',' '),"popis"=>"% Auss","sirka"=>0,"ram"=>'1',"align"=>"R","radek"=>1,"fill"=>0),
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function zahlavi_teil($pdfobjekt,$vyskaradku,$rgb,$cells_header,$teilnr)
{
	$pdfobjekt->SetFillColor($rgb[0],$rgb[1],$rgb[2],1);
	$fill=1;
	$pdfobjekt->SetFont("FreeSans", "B", 8);

	$pdfobjekt->Cell(0,$vyskaradku,$teilnr,'1',1,'L',$fill);
...
function zapati_teil($pdfobjekt,$node,$vyskaradku,$popis,$rgb,$pole,$teilnr)
{
	...
	$obsah=$pole['auss_celkem'];;
	$obsah=number_format($obsah,0,',',' ');
	$pdfobjekt->Cell(10,$vyskaradku,$obsah,'1',0,'R',$fill);

	$obsah=$pole['gut_stk'];
	$obsah=number_format($obsah,0,',',' ');
	$pdfobjekt->Cell(15,$vyskaradku,$obsah,'1',0,'R',$fill);

	if($pole['gut_stk']!=0)
		$obsah=$pole['auss_celkem']/$pole['gut_stk']*100;
	else
		$obsah=0;
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "D361 Summe Ausschuss nach Ausschussarten", $params);
//set margins
...
foreach($teile as $teil)
{
	...
	zahlavi_teil($pdf,5,array(255,255,100),$cells_header,$teilnr);
	nuluj_sumy_pole($sum_zapati_teil_array);
	
	$auftraege=$teil->getElementsByTagName("auftrag");
	...
	test_pageoverflow($pdf,5,$cells_header,5);
	zapati_teil($pdf,$auftrag,5,"Summe Teil",array(255,255,255),$sum_zapati_teil_array,$teilnr);
