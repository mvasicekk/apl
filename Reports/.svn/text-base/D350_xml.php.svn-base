...
$pcip=get_pc_ip();
$views=array("pt_D350","pt_D350_summe_lieferung","pt_D350_importgew");
...
$pt_D350=$pcip.$views[0];
$pt_D350_summe_lieferung=$pcip.$views[1];
$pt_D350_importgew=$pcip.$views[2];

$sql=" select auftragsnr,import_gew,teil,pal,gew,";
...
$sql.=" auss_celkem,summe_lieferung,summe_lieferung-auss_celkem as delta_auss,gew_auss_teil_pal";
$sql.=" from $pt_D350 join $pt_D350_summe_lieferung";
$sql.=" using(auftragsnr,teil,pal)  join $pt_D350_importgew using(auftragsnr)";
