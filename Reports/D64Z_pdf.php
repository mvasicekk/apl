...
$sql.="     dbehexport.id,";
$sql.="     dbehexport.teil,";
$sql.="     dbehexport.ex_pal as pal,";
$sql.="     dbehexport.ex_stk_gut,";
$sql.="     dkopf.Kunde as kunde,";
$sql.="     dkopf.Gew as gew,";
$sql.="     dkopf.verpackungmenge";
$sql.=" from";
$sql.="     dbehexport";
$sql.=" join dkopf on dkopf.Teil=dbehexport.teil";
$sql.=" where";
$sql.="     dbehexport.export='$export'";
$sql.="     and dbehexport.nicht_in_export=0";
$sql.="     and dbehexport.gedruckt_am is null";
$sql.=" order by";
$sql.="     dbehexport.ex_pal";
...
if($rows!==NULL){
    foreach ($rows as $row){
	$teil = $row['teil'];
	//$verpackungmenge = $row['verpackungmenge'];
	$verpackungmenge = $row['ex_stk_gut'];
	$palNr = $row['pal'];
	$gew = $row['gew'];
	$kunde = $row['kunde'];
	...
	// upravit datum tisku pro danou paletu
	$apl->updateBehExport('gedruckt_am', date('Y-m-d H:i:s'), $row['id']);
    }
}
