 ...
 * @param <type> $tagen
 */
function stitek($pdf,$vyskaradku,$rgb,$childs)
{
    global $ersteller;
	...
	$y_pocatek=$pdf->GetY();
        ...
        $pdf->Cell($sirkaDeska, 5, 'Deska/Plate:                   T010 Lagerzettel', '0', 1, 'L', 0);
        // obsah
	...
	// ersteller
        ...
        $pdf->SetX($xTeil);$pdf->SetY($yTeil+5);
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "T010 Lagerzettel", '');
//set margins
