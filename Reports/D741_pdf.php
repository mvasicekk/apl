...
function zapati_rechnung($pdfobjekt,$vyskaradku,$rgb,$childNodes,$sumarray)
{
	...
	$pdfobjekt->SetFillColor($rgb[0],$rgb[1],$rgb[2],1);
	$pdfobjekt->SetFont("FreeSans", "B", 8);
	$pdfobjekt->Cell(20+45+45+10+12,$vyskaradku,"",'T',0,'R',1);
...
//$pdf->SetHeaderData("", 0, "D741 Rechnung", $params);
$pdf->SetHeaderData("", 0, "", "");
...
$pdf->SetFooterMargin(PDF_MARGIN_FOOTER+7);
