...
function rebuildpage()
{
	...
	var offsetTopscrollNode = scrollNode.offsetTop;
	
	//var scrollAplNode1 = document.getElementById('scroll_export');
	
	
	var yPozice = YAHOO.util.Dom.getY("scroll");
	var yPoziceFooter = YAHOO.util.Dom.getY("dauftr_form_footer");
	vyskaApl=yPoziceFooter-yPozice-10;
	scrollNode.style.height=vyskaApl;
	
	textSouradnice='clientHeight='+clientHeight+'<br>clientWidth='+clientWidth;
	textSouradnice+='<br>scrollNode='+scrollNode.nodeName;
	textSouradnice+='<br>offsetTopscrollNode='+offsetTopscrollNode;
	textSouradnice+='<br>yPozice='+yPozice;
	textSouradnice+='<br>yPoziceFooter='+yPoziceFooter;
...
function fillIdlist()
{
	...
	for(i=1;i<rows.length;i++)
	{
		...
		gut = rows.item(i).getElementsByTagName('td').item(5).firstChild.data;
		auss2 = rows.item(i).getElementsByTagName('td').item(6).firstChild.data; 
		auss4 = rows.item(i).getElementsByTagName('td').item(7).firstChild.data; 
		auss6 = rows.item(i).getElementsByTagName('td').item(8).firstChild.data; 
...
function insertExport(rows_array,i)
{
	...
	if(rows_array.item(i).getElementsByTagName('td').item(9).hasChildNodes() && rows_array.item(i).getElementsByTagName('td').item(9).firstChild.data=='G')
	...
	td_abgnr.innerHTML=rows_array.item(i).getElementsByTagName('td').item(4).firstChild.data;
	td_abgnr.setAttribute('class',rows_array.item(i).getElementsByTagName('td').item(4).getAttribute('class'));
	...
	td_tatkz.innerHTML=rows_array.item(i).getElementsByTagName('td').item(3).firstChild.data;
	td_tatkz.setAttribute('class',rows_array.item(i).getElementsByTagName('td').item(3).getAttribute('class'));

	var td_gutstk = document.createElement('td');
	td_gutstk.innerHTML=rows_array.item(i).getElementsByTagName('td').item(5).firstChild.data;
	td_gutstk.setAttribute('class',rows_array.item(i).getElementsByTagName('td').item(5).getAttribute('class'));

	var td_auss2 = document.createElement('td');
	td_auss2.innerHTML=rows_array.item(i).getElementsByTagName('td').item(6).firstChild.data;
	td_auss2.setAttribute('class',rows_array.item(i).getElementsByTagName('td').item(6).getAttribute('class'));

	var td_auss4 = document.createElement('td');
	td_auss4.innerHTML=rows_array.item(i).getElementsByTagName('td').item(7).firstChild.data;
	td_auss4.setAttribute('class',rows_array.item(i).getElementsByTagName('td').item(7).getAttribute('class'));

	var td_auss6 = document.createElement('td');
	td_auss6.innerHTML=rows_array.item(i).getElementsByTagName('td').item(8).firstChild.data;
	td_auss6.setAttribute('class',rows_array.item(i).getElementsByTagName('td').item(8).getAttribute('class'));
