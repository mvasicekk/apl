...
foreach ($kundenNrArray as $kd=>$v){
    ...
    $pdf->Cell($stkWidth/2,$rowHeight,'Ist / '.$ba,'LRBT',0,'C',1);
...
if($mitdetail===TRUE){
    ...
    $pdf->Cell($stkWidth,$rowHeight,"Teil",'LRBT',0,'C',1);
    $pdf->Cell($stkWidth,$rowHeight,"Pers",'LRBT',0,'C',1);
    $pdf->Cell($stkWidth,$rowHeight,"Name",'LRBT',0,'C',1);
    $pdf->Cell($stkWidth,$rowHeight,"Auss6Stk",'LRBT',0,'C',1);
    $pdf->Ln();
        foreach($detailArray as $jmk=>$kundeRow){
        ...
        foreach ($kundeRow as $kd=>$detailRow){
            ...
            foreach ($detailRow as $r){
                ...
                $pdf->Cell($stkWidth,$rowHeight,$r['teil'],'LRBT',0,'R',0);
                $pdf->Cell($stkWidth,$rowHeight,$r['persnr'],'LRBT',0,'R',0);
                $pdf->Cell($stkWidth,$rowHeight,$r['persname'],'LRBT',0,'L',0);
                $pdf->Cell($stkWidth,$rowHeight,$r['sum_auss6'],'LRBT',0,'R',0);
