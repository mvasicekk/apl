...
$cells = 
array(
'datumf'=> array ("popis"=>"","sirka"=>20,"ram"=>'0',"align"=>"L","radek"=>0,"fill"=>0),
'persnr_ma'=> array ("popis"=>"","sirka"=>15,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>0),
'name'=> array ("substring"=>array(0,30),"popis"=>"","sirka"=>30,"ram"=>'0',"align"=>"L","radek"=>0,"fill"=>0),
'persnr_reparatur'=> array ("popis"=>"","sirka"=>15,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>0),
'bemerkung'=> array ("substring"=>array(0,40),"popis"=>"","sirka"=>40,"ram"=>'0',"align"=>"L","radek"=>0,"fill"=>0),
'rep_kosten'=> array ("nf"=>array(0,',',' '),"popis"=>"","sirka"=>25,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>0),  
'et_kosten'=> array ("nf"=>array(0,',',' '),"popis"=>"","sirka"=>25,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>0),    
...
$cells_header = 
array(
'datumf'=> array ("popis"=>"Repdatum","sirka"=>20,"ram"=>'0',"align"=>"L","radek"=>0,"fill"=>1),
'persnr_ma'=> array ("popis"=>"PersNr","sirka"=>15,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>1),
'name'=> array ("popis"=>"Name","sirka"=>30,"ram"=>'0',"align"=>"L","radek"=>0,"fill"=>1),
'persnr_reparatur'=> array ("popis"=>"PersNr-Rep","sirka"=>15,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>1),
'bemerkung'=> array ("popis"=>"Bemerkung","sirka"=>40,"ram"=>'0',"align"=>"L","radek"=>0,"fill"=>1),
'rep_kosten'=> array ("popis"=>"RepKosten","sirka"=>25,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>1),  
'et_kosten'=> array ("popis"=>"EtKosten","sirka"=>25,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>1),    
'lf'=> array ("popis"=>"","sirka"=>0,"ram"=>'0',"align"=>"BR","radek"=>1,"fill"=>1),
);
...
function zahlavi_maschine($pdfobjekt,$vyskaradku,$rgb,$childs)
{
	...
	$fill=1;
        ...
        $anlage = getValueForNode($childs, 'anlage_beschreibung');

	$pdfobjekt->Cell(0,$vyskaradku,$invnr.' '.$anlage,'T',1,'L',$fill);
	$pdfobjekt->SetFillColor($prevFillColor[0],$prevFillColor[1],$prevFillColor[2]);
}
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "S515 Reparaturen nach InvNr", $params);
//set margins
...
$maschinen=$domxml->getElementsByTagName("maschine");
foreach($maschinen as $maschine)
{
    $maschineChilds=$maschine->childNodes;
    zahlavi_maschine($pdf, 5, array(255,255,250), $maschineChilds);
    $reparaturen = $maschine->getElementsByTagName("reparatur");
    foreach($reparaturen as $reparatur){
        $reparaturChilds = $reparatur->childNodes;
        test_pageoverflow($pdf,5,$cells_header);
        telo($pdf,$cells,5,array(255,255,255),"",$reparaturChilds);
    }
//    
