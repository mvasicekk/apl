...
//	$pdfobjekt->MyMultiCell(15,4,"Schicht\nsmena",1,'L',0);
	...
	$pdfobjekt->MyMultiCell(28,4,"1.vzor (o.č.)\n1.Muster (PersNr)",1,'L',0);
	$pdfobjekt->SetFont("FreeSans", "", 9);
	$pdfobjekt->MyMultiCell(40,4,"Stuck / kus\ngut            A-Stk/Art",1,'L',0);
	$pdfobjekt->MyMultiCell(40,4,"Arbeitszeit\nvon/od    bis/do",1,'C',0);
	//$pdfobjekt->SetFont("FreeSans", "B", 15);
	$pdfobjekt->MyMultiCell(25,4,"Q (o.č.)\nQ (PersNr)",1,'L',0);
	$pdfobjekt->MultiCell(0,4,"SYS (o.č.)\nSYS (PersNr)",1,'L',0);
	// radky tabulky
	$table = array(
	    array(25,'1',10),
	    array(20,'1',10),
