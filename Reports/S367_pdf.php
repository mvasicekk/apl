...
foreach ($jahrMonatArray as $jm=>$v1){
	...
	$pdf->Cell(5*$mntWidth,$rowHeight,$kr['bereich'],'LRTB',0,'L',$fill);
	$pdf->Ln();
    }
...
array_push($monatGraphArray,$avg);
	...
	, "R" => 42, "G" => 18, "B" => 255);
    $myPicture->drawText($imgWidth/2, 25, "Reklamace od zakazniku $kdvon - $kdbis, obdobi $von - $bis", $TextSettings);
...
//toto taky funguje
    ...
    // pro pouziti vice grafu na strance
    // 
    // 
