...
$summenKundeArray = array();
$summenKgKundeArray = array();
...
function radek_auftrag($pdfobjekt,$vyskaradku,$rgb,$childs,$aussArtArray,$auftragNode,$teilChilds)
{
	...
	global $summenBerichtArray;
        global $summenKgKundeArray;
	global $summenKundeArrayArray;
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "S372 Teil/Auftrag Ausschussarten", $params);
//set margins
