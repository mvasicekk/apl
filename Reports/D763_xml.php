...
$pt.=" GROUP BY drechneu.kunde, drechneu.AuftragsNr, drechneu.vom, drechneu.an, drechneu.origauftrag,drechneu.fremdauftr, drechneu.fremdpos,drechneu.Teil, drechneu.teilbez, drechneu.`Taet-kz`, drechneu.DM, drechneu.abgnr";
$db->query($pt);
...
$sql.=" GROUP BY $D743_sumteilstk.kunde, auftragsnr, $D743_sumteilstk.vom, $D743_sumteilstk.an, fremdauftr, fremdpos, Teil, teilbez, tat,stk";
