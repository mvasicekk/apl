...
if($typ=='Ausschuss')
    $pt.=" and (dauftr.auss2_stk_exp<>0 or dauftr.auss4_stk_exp<>0 or dauftr.auss6_stk_exp<>0)";

if($typ=='Mehrarbeit')
    $pt.=" and (dauftr.abgnr>=2000 and dauftr.abgnr<>2095)";

$pt.=" and (dauftr.abgnr<>2095)";
$pt.=" )";
...
$sql=" SELECT $D710_exportstk.`auftragsnr-exp` as ex,";
 ...
 $sql.=" $export_uebersicht_geliefert_teil.geliefert as expstk,";
 ...
 $sql.=" $D710_exportstk.`Summevonstk-exp` as expstk1,";
