...
*}	{if $prihlasen}
		...
		<div id='buttoncontainer'>
			...
			<input id="D725" onClick="location.href='../get_parameters.php?popisky=Export;Termin,*DATE;Typ,*RA&promenne=export!number;termin;typ&values=;{$now};Gute Teile,Ausschuss,Mehrarbeit&report=D725'" class='reportbutton' type="button"  name="D725" value="D725 - Liefer und Leistungsuebersicht (AArt)"/>
			<input id="D729" onClick="location.href='../get_parameters.php?popisky=Export&promenne=export!number&values=&report=D729'" class='reportbutton' type="button"  name="D729" value="D729 - VDA Test"/>
			...
			<input id="S210" style="display:{$display_sec.S210_sec}" onClick="location.href='../get_parameters.php?popisky=AuftragsNr&promenne=auftragsnr!number&values=&report=S210'" class='reportbutton' type="button"  name="S210" value="S210 - Leistung Auftrag - Teil"/>
			<input id="S210noex" style="display:{$display_sec.S210noex_sec}" onClick="location.href='../get_parameters.php?popisky=AuftragsNr von;AuftragsNr bis;Teil&promenne=auftragsnr_von!number;auftragsnr_bis!number;teil&values=;;*&report=S210noex'"class='reportbutton' type="button"  name="S210noex" value="S210 - Leistung Auftrag - Teil ohne Export"/>
			<input id="S211" style="display:{$display_sec.S211_sec}" onClick="location.href='../get_parameters.php?popisky=ExportNr;TaetNr von;TeatNr bis&promenne=export!number;tatvon!number;tatbis!number&values=;0;9999&report=S211'" class='reportbutton' type="button"  name="D350_etc" value="S211 - Leistung Auftrag - Teil nach Export"/>
                        <input id="S212" style="display:{$display_sec.S212_sec}" onClick="location.href='../get_parameters.php?popisky=Export (geplant);Reporttyp,*RA&promenne=termin;reporttyp&values=;Kunde,Expediteur&report=S212'" class='reportbutton' type="button"  name="S212" value="S212 - Export Tablo"/>
			<input id="S214" style="display:{$display_sec.S214_sec}" onClick="location.href='../get_parameters.php?popisky=geplant mit von;geplant mit bis;abgnr von;abgnr bis;Teil;StatNr,*CB;Reporttyp,*RA&promenne=gepl_von!number;gepl_bis!number;abgnrvon!number;abgnrbis!number;teil;statnr;reporttyp&values=;;0;9999;*;{$statpolozky};mit VzKd,VzAby&report=S214'" class='reportbutton' type="button"  name="S214" value="S214 - Leistung Auftrag - geplant"/>
			<input id="S215" style="display:{$display_sec.S215_sec}" onClick="location.href='../get_parameters.php?popisky=geplant mit von;geplant mit bis;abgnr von;abgnr bis;Teil;StatNr,*CB;Reporttyp,*RA&promenne=gepl_von!number;gepl_bis!number;abgnrvon!number;abgnrbis!number;teil;statnr;reporttyp&values=;;0;9999;*;{$statpolozky};mit VzKd,VzAby&report=S215'" class='reportbutton' type="button"  name="S215" value="S215 - Leistung Teil - Auftrag - geplant"/>
			<input id="S216" style="display:{$display_sec.S216_sec}" onClick="location.href='../get_parameters.php?popisky=Kunde von;Kunde bis&promenne=kundevon!number;kundebis!number&values=0;999&report=S216'" class='reportbutton' type="button"  name="S216" value="S216 - VzKd stand - Dispo"/>
			<input id="S218" style="display:{$display_sec.S218_sec}" onClick="location.href='../get_parameters.php?popisky=Datum von,*DATE;Datum bis,*DATE;RM bis (Zeit);Kunde von;Kunde bis&promenne=von;bis;rm_bis;kundevon!number;kundebis!number&values={$now};;{$nowZeit};0;999&report=S218'" class='reportbutton' type="button"  name="S218" value="S218 - Dispo Plan"/>
			<input id="S220noex" style="display:{$display_sec.S220noex_sec}" onClick="location.href='../get_parameters.php?popisky=AuftragsNr von;AuftragsNr bis;Teil&promenne=auftragsnr_von!number;auftragsnr_bis!number;teil&values=;;*&report=S220noex'"class='reportbutton' type="button"  name="S220noex" value="S220 - Leistung Auftrag - Teil/Pal ohne Export"/>
			<input id="S221" style="display:{$display_sec.S221_sec}" onClick="location.href='../get_parameters.php?popisky=ExportNr&promenne=export!number&values=&report=S221'"class='reportbutton' type="button"  name="S221" value="S221 - Leistung Auftrag - Palette Export"/>
			<input id="S240" style="display:{$display_sec.S240_sec}" onClick="location.href='../get_parameters.php?popisky=Datum von,*DATE;Datum bis,*DATE&promenne=datum_von;datum_bis&values={$predchozi_den};{$predchozi_den}&report=S240'" class='reportbutton' type="button"  name="S240" value="S240 - Leistung Tat.gruppe - Kunde - Auftrag"/>
			<input id="S250" style="display:{$display_sec.S250_sec}" onClick="location.href='../get_parameters.php?popisky=Datum von,*DATE;Datum bis,*DATE;Schicht von;Schicht bis&promenne=datum_von;datum_bis;schicht_von!number;schicht_bis!number&values={$predchozi_den};{$predchozi_den};1;99999&report=S250'" class='reportbutton' type="button"  name="S250" value="S250 - Leistung Schicht - Auftrag"/>
		    </div>
...
{*			<input id="S810" onClick="location.href='../get_parameters.php?popisky=Auftrag von;Auftrag bis;Teil&promenne=auftragsnr_von!number;auftragsnr_bis!number;teil&values=;;&report=S810'" class='reportbutton' type="button"  name="S810" value="S810 - Teil - Bearbeitungsstand"/>*}
			...
			<input id="S818" onClick="location.href='../get_parameters.php?popisky=Kunde von;Kunde bis;Teil;Pal&promenne=kunde_von!number;kunde_bis!number;teil;pal&values=;;*;*&report=S818'" class='reportbutton' type="button"  name="S818" value="S818 - T_neodeslane Teil/Auftr"/>
