...
"bezeichnung" 
=> array ("popis"=>"Import","sirka"=>40,"ram"=>'0',"align"=>"L","radek"=>0,"fill"=>1),

"dienstleistung" 
=> array ("popis"=>"Art der Dienstleistung","sirka"=>40,"ram"=>'0',"align"=>"L","radek"=>0,"fill"=>1),

"palnr" 
=> array ("popis"=>"Beh.","sirka"=>10,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>1),

"auss" 
=> array ("popis"=>"Auss.","sirka"=>12,"ram"=>'0',"align"=>"R","radek"=>0,"fill"=>1),
...
function pageheader($pdfobjekt,$cells,$childnodes)
{
	...
	$pdfobjekt->Cell(50,7,"D752",'TB',0,'L',0);
...
function zapati_sestava($pdfobjekt,$vyskaradku,$rgb,$childNodes)
{
	...
	$pdfobjekt->Ln();
	$pdfobjekt->Cell(0,$vyskaradku,"Mit freundlichen Gruessen",'0',1,'L',0);
...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, "D752 Rechnung", $params);
//set margins
