...
$pt.= "     ,CONCAT(`eink-artikel`.`art-name1`,' - ',if(`eink-artikel`.`art-name2` is null,'',`eink-artikel`.`art-name2`)) as artname";
//$pt.= "     ,'ddd' as artname";
...
if (!$bPraemien) {
    ...
    $sql.= "     ,CONCAT(`eink-artikel`.`art-name1`,' - ',if(`eink-artikel`.`art-name2` is null,'',`eink-artikel`.`art-name2`)) as artname";
