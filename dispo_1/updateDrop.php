...
if ($imex == 'im') {
	...
	foreach ($importeDatumArray[$datumVon][$kundeVon] as $import) {
	    $targetTD.="<div id='im_" . $import['import'] . "' class='importnr ".$import['draggable']."'>Im<b>" . $import['import'] . "</b>/" . $import['im_soll_time'] . "<br>IM:vzkd&nbsp;".$import['vzkdsoll_import']."</div>";
	}
	...
	foreach ($exporteDatumArray[$datumVon][$kundeVon] as $export) {
	    $targetTD.="<div id='ex_" . $export['export'] . "' class='exportnr " . $export['draggable'] . " " . $export['auslief'] . " " . $export['fertig'] . "'>Ex<b>" . $export['export'] . "</b>/" . $export['exporttime'] . "<br>" . $export['zielort'] . "</div>";
	}
    }
