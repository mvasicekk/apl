...
$apl = AplDB::getInstance();
	...
	$div.="<tr>";
	    ...
	    //time
	    $div.="<td>";
	    $div.="<input type='text' id='aufdattime_$kundeBoxId' maxlength='5' size='5' value='$aufdat_time' />";
	    $div.="</td>";
	    ...
	    //time
	    $div.="<td>";
	    $div.="<input type='text' id='ausgeliefertamtime_$kundeBoxId' maxlength='5' size='5' value='$ausgelieferttime' />";
	    $div.="</td>";
