...
require_once '../db.php';
	...
	$zuBearbArray[$index] = number_format($apl->getPlanZuBearbeiten("P".$plan, $statnr, $time,$rmDateTime),0,',',' ');
	$index = "zubearbeiten_P".$plan."_sum_".date('Ymd',$time);
	$zuBearbArray[$index] = number_format($apl->getPlanZuBearbeiten("P".$plan, "sum", $time,$rmDateTime),0,',',' ');
