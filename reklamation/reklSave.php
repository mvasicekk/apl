...
//    'import' => trim($rekl->import),
    ...
    'anerkannt_stk_ausschuss_selbst' => intval($rekl->anerkannt_stk_ausschuss_selbst), //*
...
//'stk_unklar'=>,
    ...
    "anerkannt_ausschuss_selbst_beleg" => trim($rekl->anerkannt_ausschuss_selbst_beleg),
    "anerkannt_ausschuss_preis_eur" => floatval(strtr($rekl->anerkannt_ausschuss_preis_eur, ',', '.')),
    "anerkannt_ausschuss_selbst_preis_eur" => floatval(strtr($rekl->anerkannt_ausschuss_selbst_preis_eur, ',', '.')),
    ...
    'forecast_anerkannt_ausschuss_selbst_eur'  => floatval(strtr($rekl->forecast_anerkannt_ausschuss_selbst_eur, ',', '.')),
