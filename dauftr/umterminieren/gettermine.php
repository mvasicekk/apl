...
$panelydiv.="<thead>";
$panelydiv.="<tr><th>Export</th><th>exportiert am:</th><th>export plan</th><th>Export NEU</th><th>Export NEU Datum</th><th>Export NEU Uhrzeit</th><th>Bemerkung</th></tr>";
$panelydiv.="</thead>";
if($termineRows!==NULL){
    $index=0;
    $hasRows=1;
	...
	$panelydiv.="<td>"."<input acturl='./bemerkungUpdate.php' id='bemerkung_".$termin['termin']."' type='text' value='".$termin['bemerkung']."' size='35' maxlength='255'"."</td>";
        $panelydiv.="</tr>";
    }
}
else{
